...
- (id) initWithDictionary:(NSDictionary *)dictionary  {
    ...
    if (self) {
        ...
        self.profileLargeImageUrl = [self.profileImageUrl stringByReplacingOccurrencesOfString:@"normal"      withString:@"400x400"];
        self.profileBiggerImageUrl = [self.profileImageUrl stringByReplacingOccurrencesOfString:@"normal"                          withString:@"bigger"];
